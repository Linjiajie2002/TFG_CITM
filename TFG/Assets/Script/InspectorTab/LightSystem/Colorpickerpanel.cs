...
{
    [Header("=== �۵�̬ ===")]
    public Button swatchButton;           // ���չ��
    public Image swatchImage;            // ��ʾ��ǰ��ɫ

    [Header("=== ����ѡɫ�� ===")]
    public GameObject pickerPanel;        // ����չ�����

    [Header("=== SV �������� ===")]
    public RawImage svSquare;             // ���Ͷ�/����
    public RectTransform svCursor;        // СԲȦ���
    ...
    private bool colorAlreadySet = false; // 标记 SetColor 是否已被外部(如 BindClip)调用过
