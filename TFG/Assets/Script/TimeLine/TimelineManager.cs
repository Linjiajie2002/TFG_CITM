...
public class TimelineManager : MonoBehaviour
{
    ...
    private Color defaultHeaderColor = new Color(0.769f, 0.776f, 0.784f, 1f);
    private Color defaultClipColor = new Color(0.133f, 0.827f, 0.784f, 1f);
    private Color highlightColor = new Color(0.251f, 0.722f, 0.945f, 1f);
    private Color selectedClipColor = new Color(0.918f, 0.553f, 0.757f, 1f);
